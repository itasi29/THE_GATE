...
/// 画面モードを設定する
/// </summary>
/// <param name="ScreenSizeX">画面の横のサイズ</param>
/// <param name="ScreenSizeY">画面の縦のサイズ</param>
/// <param name="ColorBitDepth">カラービット</param>
/// <returns></returns>
extern	int				SetGraphMode(								int ScreenSizeX, int ScreenSizeY, int ColorBitDepth, int RefreshRate DEFAULTPARAM( = 60 ) ) ;
...
/// <summary>
/// 画面モード変更時にグラフィックスシステムの設定やグラフィックハンドルをリセットするかどうかを設定する
/// </summary>
/// <param name="Flag">true: リセットする(デフォ)/ false: リセットしない</param>
/// <returns></returns>
